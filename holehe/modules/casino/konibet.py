...
async def konibet(email, client, out):
    name = "konibet"
    domain = "konibet.com"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://www.konibet.com',
        'Referer': 'https://www.konibet.com/',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://konibet.com/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://konibet.com/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
