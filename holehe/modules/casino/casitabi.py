...
async def casitabi(email, client, out):
    name = "casitabi"
    domain = "casitabi.com"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://www.casitabi.com',
        'Referer': 'https://www.casitabi.com/',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://www.casitabi.com/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://www.casitabi.com/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
