...
async def verajohn(email, client, out):
    name = "verajohn"
    domain = "vera-john.com"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://www.vera-john.com',
        'Referer': 'https://www.vera-john.com/',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://www.vera-john.com/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://www.vera-john.com/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
