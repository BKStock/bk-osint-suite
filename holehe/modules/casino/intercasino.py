...
async def intercasino(email, client, out):
    name = "intercasino"
    domain = "intercasino.com"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://www.intercasino.com',
        'Referer': 'https://www.intercasino.com/',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://intercasino.com/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://intercasino.com/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
