...
async def roobet(email, client, out):
    name = "roobet"
    domain = "roobet.com"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://www.roobet.com',
        'Referer': 'https://www.roobet.com/',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://roobet.com/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://roobet.com/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
