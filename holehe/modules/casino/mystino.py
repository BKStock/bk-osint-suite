...
async def mystino(email, client, out):
    name = "mystino"
    domain = "mystino.com"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://www.mystino.com',
        'Referer': 'https://www.mystino.com/',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://mystino.com/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://mystino.com/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
