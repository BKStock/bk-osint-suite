...
async def bitstarz(email, client, out):
    name = "bitstarz"
    domain = "bitstarz.com"
    method = "register"
    ...
    try:
        ...
        response = await client.post(
            'https://www.bitstarz.com/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://www.bitstarz.com/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
