...
async def yuugado(email, client, out):
    name = "yuugado"
    domain = "yuugado.com"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://www.yuugado.com',
        'Referer': 'https://www.yuugado.com/',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://yuugado.com/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://yuugado.com/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
