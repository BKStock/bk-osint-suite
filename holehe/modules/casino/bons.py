...
async def bons(email, client, out):
    name = "bons"
    domain = "bons.com"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://www.bons.com',
        'Referer': 'https://www.bons.com/',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://bons.com/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://bons.com/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
