...
async def kucoin(email, client, out):
    name = "kucoin"
    domain = "kucoin.com"
    method = "register"
    ...
    headers = {
        ...
        'Referer': 'https://www.kucoin.com/ucenter/signup',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://www.kucoin.com/_api/v1/user/account/check',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://www.kucoin.com/_api/v1/user/account/forgot/send-email',
            headers=headers,
            json=data2,
            timeout=10
        )
