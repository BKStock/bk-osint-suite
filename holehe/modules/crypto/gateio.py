...
async def gateio(email, client, out):
    name = "gateio"
    domain = "gate.io"
    method = "register"
    ...
    headers = {
        ...
        'Referer': 'https://www.gate.io/signup',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://www.gate.io/api/account/checkEmail',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://www.gate.io/api/account/forgot_password/email',
            headers=headers,
            json=data2,
            timeout=10
        )
