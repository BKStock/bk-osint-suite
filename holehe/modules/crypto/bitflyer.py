...
async def bitflyer(email, client, out):
    name = "bitflyer"
    domain = "bitflyer.com"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://bitflyer.com',
        'Referer': 'https://bitflyer.com/ja-jp/ex/account',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://bitflyer.com/api/account/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://bitflyer.com/api/account/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
