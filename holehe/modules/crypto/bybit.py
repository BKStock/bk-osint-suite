...
async def bybit(email, client, out):
    name = "bybit"
    domain = "bybit.com"
    method = "register"
    ...
    headers = {
        ...
        'Referer': 'https://www.bybit.com/en/register',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://api2.bybit.com/user/public/check-user-exist',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://api2.bybit.com/user/public/forgot-password/send-email',
            headers=headers,
            json=data2,
            timeout=10
        )
