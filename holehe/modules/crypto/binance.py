...
async def binance(email, client, out):
    name = "binance"
    domain = "binance.com"
    method = "register"
    ...
    try:
        ...
        response = await client.post(
            'https://accounts.binance.com/bapi/composite/v2/public/otp/send',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://accounts.binance.com/bapi/accounts/v1/protect/account/email/sendForgetPasswordEmail',
            headers=headers,
            json=data2,
            timeout=10
        )
