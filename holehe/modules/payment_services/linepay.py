...
async def linepay(email, client, out):
    name = "linepay"
    domain = "pay.line.me"
    method = "register"
    ...
    headers = {
        ...
        'Origin': 'https://pay.line.me',
        'Referer': 'https://pay.line.me/',
    }

    try:
        data = {"email": email}
        response = await client.post(
            'https://pay.line.me/api/user/register/check-email',
            headers=headers,
            json=data,
            timeout=10
        )
        ...
        response2 = await client.post(
            'https://pay.line.me/api/user/forgot-password',
            headers=headers,
            json=data2,
            timeout=10
        )
